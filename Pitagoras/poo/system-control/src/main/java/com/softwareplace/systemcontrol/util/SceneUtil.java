package com.softwareplace.systemcontrol.util;
...
import com.softwareplace.systemcontrol.SystemControlApplication;
...
public class SceneUtil {
	...
	public static void stage(Stage stage, String xmlView) throws IOException {
		FXMLLoader contactListView = new FXMLLoader(SystemControlApplication.class.getResource(String.format("view/%s", xmlView)));
